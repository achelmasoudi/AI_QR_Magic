...
public class ScannedInstagram extends AppCompatActivity {

    private TextView username;
    private String instagramLink , myUsername;
    private CircleImageView saveBtn , savedSuccessBtn , moreBtn;
    private TextView saveTxtView , savedSuccessTxtView;
    private CircleImageView openInstagramBtn , copyBtn , copiedSuccessBtn , searchOnWebBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanned_instagram);

        qrCodeImage = (ImageView) findViewById(R.id.qrCodeImageIdScannedInstagram);

        //For the BottomSheet
        frameLayout = (FrameLayout) findViewById(R.id.bottomSheetIdFrameLayoutScannedInstagram);
        bottomSheetBehavior = BottomSheetBehavior.from(frameLayout);
        bottomSheetBehavior.setPeekHeight(0);

        //When the bottomSheet is Expanded The Shadow will appear
        shadowFromView = (View) findViewById(R.id.shadowFromViewId_ScannedInstagram);
        ...
        username = (TextView) findViewById(R.id.ScannedInstagram_UsernameId);

        Bundle bundle = getIntent().getExtras();
        if(bundle!=null) {
            instagramLink = bundle.getString("url");
            // Example -- instagramLink : https://www.instagram.com/achelm9
            //take the username from the link
            myUsername = instagramLink.replace("https://www.instagram.com/" , "");
            //myUsername = achelm9
        }

        username.setText("@"+myUsername);

        moreBtn = (CircleImageView) findViewById(R.id.moreButtonIdScannedInstagram);
        ...
        saveBtn = (CircleImageView) findViewById(R.id.saveButtonIdScannedInstagram);
        savedSuccessBtn = (CircleImageView) findViewById(R.id.savedSuccessButtonIdScannedInstagram);
        saveTxtView = (TextView) findViewById(R.id.saveTxtViewIdScannedInstagram);
        savedSuccessTxtView = (TextView) findViewById(R.id.savedSuccessTxtViewIdScannedInstagram);
        saveQrCodeToScannedFragmentButton();

        generateInstagramQRCode(myUsername);
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            openInstagramBtn.setColorFilter(ContextCompat.getColor(this, R.color.white));
            ...
            openInstagramBtn.setColorFilter(ContextCompat.getColor(this, R.color.black));
    ...
    private void generateInstagramQRCode(String username) {
    ...
    private void saveQrCodeToScannedFragmentButton() {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String scanned_QrCode_Type = getResources().getString(R.string.Instagram);
                dataBaseHelperScanned.addData_Scanned(new ScannedQrCode(scanned_QrCode_Type , getResources().getString(R.string.Username_hint)+": " + myUsername , qrCodeImageBytes , R.drawable.instagram_icon));
    ...
    private void openInstagramButton() {
        openInstagramBtn = (CircleImageView) findViewById(R.id.openInstagramButtonIdScannedInstagram);
        openInstagramBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Check if the Instagram app is installed
                boolean appInstalled = isAppInstalled("com.instagram.android");
                if (appInstalled) {
                    // Instagram app is installed, open it
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setPackage("com.instagram.android");
                    intent.setData(Uri.parse("https://www.instagram.com/" + myUsername));
                    startActivity(intent);
                } else {
                    // Instagram app is not installed, open the Instagram website
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setData(Uri.parse("https://www.instagram.com/" + myUsername));
                    startActivity(intent);
                }
    ...
    private void copyButton() {
        copyBtn = (CircleImageView) findViewById(R.id.copyButtonIdScannedInstagram);
        copiedSuccessBtn = (CircleImageView) findViewById(R.id.copiedSuccessButtonIdScannedInstagram);
        copyTxtView = (TextView) findViewById(R.id.copyTxtViewIdScannedInstagram);
        copiedSuccessTxtView = (TextView) findViewById(R.id.copiedSuccessTxtViewIdScannedInstagram);
    ...
    private void searchOnWebButton() {
        searchOnWebBtn = (CircleImageView) findViewById(R.id.searchOnWebButtonIdScannedInstagram);
        searchOnWebBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ScannedInstagram.this , InAppBrowser.class);
    ...
    private void arrowBack() {
        CardView arrowBack = (CardView) findViewById(R.id.arrowback_from_ScannedInstagramId);
        arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //For Back from Activity to Fragment !!!!!
                ScannedInstagram.super.onBackPressed();
            }
        });
    }
