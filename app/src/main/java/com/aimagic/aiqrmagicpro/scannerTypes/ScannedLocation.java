...
public class ScannedLocation extends AppCompatActivity {
    ...
    private CircleImageView getDirectionsBtn , openMapBtn , searchOnWebBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanned_location);

        qrCodeImage = (ImageView) findViewById(R.id.qrCodeImageIdScannedLocation);

        //For the BottomSheet
        frameLayout = (FrameLayout) findViewById(R.id.bottomSheetIdFrameLayoutScannedLocation);
        bottomSheetBehavior = BottomSheetBehavior.from(frameLayout);
        bottomSheetBehavior.setPeekHeight(0);

        //When the bottomSheet is Expanded The Shadow will appear
        shadowFromView = (View) findViewById(R.id.shadowFromViewId_ScannedLocation);
        ...
        geo = (TextView) findViewById(R.id.ScannedLocation_GeoId);

        Bundle bundle = getIntent().getExtras();
        if(bundle!=null) {
            myLatitude = bundle.getString("latitude");
            myLongitude = bundle.getString("longitude");
        }

        geo.setText( getResources().getString(R.string.Latitude) + ": " + myLatitude + "\n"+ getResources().getString(R.string.Longitude) +": " + myLongitude);

        moreBtn = (CircleImageView) findViewById(R.id.moreButtonIdScannedLocation);
        ...
        saveBtn = (CircleImageView) findViewById(R.id.saveButtonIdScannedLocation);
        savedSuccessBtn = (CircleImageView) findViewById(R.id.savedSuccessButtonIdScannedLocation);
        saveTxtView = (TextView) findViewById(R.id.saveTxtViewIdScannedLocation);
        savedSuccessTxtView = (TextView) findViewById(R.id.savedSuccessTxtViewIdScannedLocation);
        saveQrCodeToScannedFragmentButton();

        generateLocationQRCode(myLatitude , myLongitude);
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            getDirectionsBtn.setColorFilter(ContextCompat.getColor(this, R.color.white));
            searchOnWebBtn.setColorFilter(ContextCompat.getColor(this, R.color.white));
            openMapBtn.setColorFilter(ContextCompat.getColor(this, R.color.white));
        }
        else {
            ...
            getDirectionsBtn.setColorFilter(ContextCompat.getColor(this, R.color.black));
            searchOnWebBtn.setColorFilter(ContextCompat.getColor(this, R.color.black));
            openMapBtn.setColorFilter(ContextCompat.getColor(this, R.color.black));
        }
    }

    //Generate the qr code that the camera read it in put it in image view
    public void generateLocationQRCode(String latitude, String longitude) {
    ...
    private void saveQrCodeToScannedFragmentButton() {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String scanned_QrCode_Type = getResources().getString(R.string.Location);
                dataBaseHelperScanned.addData_Scanned(new ScannedQrCode(scanned_QrCode_Type , getResources().getString(R.string.Geo)+ ": " + myLatitude+" , "+myLongitude , qrCodeImageBytes , R.drawable.location_icon));
    ...
    private void getDirectionsButton() {
        getDirectionsBtn = (CircleImageView) findViewById(R.id.getDirectionsButtonIdScannedLocation);
        getDirectionsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String mapsUri = myLatitude +","+ myLongitude;
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("google.navigation:q=" + mapsUri));
    ...
    private void openMapButton() {
        openMapBtn = (CircleImageView) findViewById(R.id.openMapButtonIdScannedLocation);
        openMapBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String mapsUri = "geo:"+ myLatitude +","+ myLongitude;
    ...
    private void searchOnWebButton() {
        searchOnWebBtn = (CircleImageView) findViewById(R.id.searchOnWebButtonIdScannedLocation);
        searchOnWebBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String mapsUri = myLatitude +","+ myLongitude;
                Intent intent = new Intent(ScannedLocation.this , InAppBrowser.class);
                intent.putExtra("searchquery" , mapsUri);
                startActivity(intent);
            }
        });
    }
    ...
    private void arrowBack() {
        CardView arrowBack = (CardView) findViewById(R.id.arrowback_from_ScannedLocationId);
        arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //For Back from Activity to Fragment !!!!!
                ScannedLocation.super.onBackPressed();
            }
        });
    }
