...
public class ScannedWifi extends AppCompatActivity {

    private TextView ssid , password , securityType;
    private String mySsid , myPassword , mySecurityType;
    private CircleImageView saveBtn , savedSuccessBtn , moreBtn;
    private TextView saveTxtView , savedSuccessTxtView;
    private CircleImageView connectWifiBtn , copyBtn , copiedSuccessBtn , searchOnWebBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanned_wifi);

        qrCodeImage = (ImageView) findViewById(R.id.qrCodeImageIdScannedWifi);

        //For the BottomSheet
        frameLayout = (FrameLayout) findViewById(R.id.bottomSheetIdFrameLayoutScannedWifi);
        bottomSheetBehavior = BottomSheetBehavior.from(frameLayout);
        bottomSheetBehavior.setPeekHeight(0);

        //When the bottomSheet is Expanded The Shadow will appear
        shadowFromView = (View) findViewById(R.id.shadowFromViewId_ScannedWifi);
        ...
        ssid = (TextView) findViewById(R.id.ScannedWifi_SsidId);
        password = (TextView) findViewById(R.id.ScannedWifi_PasswordId);
        securityType = (TextView) findViewById(R.id.ScannedWifi_SecurityTypeId);

        Bundle bundle = getIntent().getExtras();
        if(bundle!=null) {
            mySsid = bundle.getString("ssid");
            myPassword = bundle.getString("password");
            mySecurityType = bundle.getString("securitytype");
        }

        ssid.setText("Ssid: " + mySsid);
        if(myPassword.equals("")) {
            password.setText( getResources().getString(R.string.Password) + ": " + getResources().getString(R.string.NoPassword));
        }
        else {
            password.setText( getResources().getString(R.string.Password) + ": " + myPassword);
        }
        securityType.setText( getResources().getString(R.string.WirelessSecurity) + ": " + mySecurityType);

        moreBtn = (CircleImageView) findViewById(R.id.moreButtonIdScannedWifi);
        ...
        saveBtn = (CircleImageView) findViewById(R.id.saveButtonIdScannedWifi);
        savedSuccessBtn = (CircleImageView) findViewById(R.id.savedSuccessButtonIdScannedWifi);
        saveTxtView = (TextView) findViewById(R.id.saveTxtViewIdScannedWifi);
        savedSuccessTxtView = (TextView) findViewById(R.id.savedSuccessTxtViewIdScannedWifi);
        saveQrCodeToScannedFragmentButton();

        generateWifiQRCode(mySsid , myPassword , mySecurityType);
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            connectWifiBtn.setColorFilter(ContextCompat.getColor(this, R.color.white));
            ...
            connectWifiBtn.setColorFilter(ContextCompat.getColor(this, R.color.black));
    ...
    private void generateWifiQRCode(String ssid, String password , String security) {
    ...
    private void saveQrCodeToScannedFragmentButton() {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String scanned_QrCode_Type = getResources().getString(R.string.WiFi);
                dataBaseHelperScanned.addData_Scanned(new ScannedQrCode(scanned_QrCode_Type , getResources().getString(R.string.Wifi) + ": "+ mySsid + " / " +myPassword + " / "+ mySecurityType , qrCodeImageBytes , R.drawable.wifi_icon));
    ...
    private void connectWifiButton() {
        connectWifiBtn = (CircleImageView) findViewById(R.id.connectWifiButtonIdScannedWifi);
    ...
    private void connectToWifi(String ssid1, String password1) {
        WifiManager wifiManager = (WifiManager) this.getApplicationContext().getSystemService(getApplicationContext().WIFI_SERVICE);
        ...
        wifiConfig.SSID = "\"" + ssid1 + "\"";
        wifiConfig.preSharedKey = "\"" + password1 + "\"";
        ...
        if (networkId != -1) {
            ...
            Toast.makeText(this, getResources().getString(R.string.ConnectingtoWiFinetwork), Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, getResources().getString(R.string.FailedtoconnecttotheWiFinetwork), Toast.LENGTH_SHORT).show();
        }
    }

    private void copyButton() {
        copyBtn = (CircleImageView) findViewById(R.id.copyButtonIdScannedWifi);
        copiedSuccessBtn = (CircleImageView) findViewById(R.id.copiedSuccessButtonIdScannedWifi);
        copyTxtView = (TextView) findViewById(R.id.copyTxtViewIdScannedWifi);
        copiedSuccessTxtView = (TextView) findViewById(R.id.copiedSuccessTxtViewIdScannedWifi);
        ...
        copyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.HONEYCOMB) {
                    ...
                    android.content.ClipData clip = android.content.ClipData.newPlainText(getResources().getString(R.string.CopiedText), myPassword);
    ...
    private void searchOnWebButton() {
        searchOnWebBtn = (CircleImageView) findViewById(R.id.searchOnWebButtonIdScannedWifi);
        searchOnWebBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ScannedWifi.this , InAppBrowser.class);
                intent.putExtra("searchquery" , mySsid);
    ...
    private void arrowBack() {
        CardView arrowBack = (CardView) findViewById(R.id.arrowback_from_ScannedWifiId);
        arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //For Back from Activity to Fragment !!!!!
                ScannedWifi.super.onBackPressed();
            }
        });
    }
