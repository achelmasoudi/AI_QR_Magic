...
public class ScannedLinkedin extends AppCompatActivity {

    private TextView username;
    private String linkedinLink , myUsername;
    private CircleImageView saveBtn , savedSuccessBtn , moreBtn;
    private TextView saveTxtView , savedSuccessTxtView;
    private CircleImageView openLinkedinBtn , copyBtn , copiedSuccessBtn , searchOnWebBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanned_linkedin);

        qrCodeImage = (ImageView) findViewById(R.id.qrCodeImageIdScannedLinkedin);

        //For the BottomSheet
        frameLayout = (FrameLayout) findViewById(R.id.bottomSheetIdFrameLayoutScannedLinkedin);
        bottomSheetBehavior = BottomSheetBehavior.from(frameLayout);
        bottomSheetBehavior.setPeekHeight(0);

        //When the bottomSheet is Expanded The Shadow will appear
        shadowFromView = (View) findViewById(R.id.shadowFromViewId_ScannedLinkedin);
        ...
        username = (TextView) findViewById(R.id.ScannedLinkedin_UsernameId);

        Bundle bundle = getIntent().getExtras();
        if(bundle!=null) {
            linkedinLink = bundle.getString("url");
            //take the username from the url
            myUsername = linkedinLink.replace("https://www.linkedin.com/in/" , "");
        }

        username.setText("@"+myUsername);

        moreBtn = (CircleImageView) findViewById(R.id.moreButtonIdScannedLinkedin);
        ...
        saveBtn = (CircleImageView) findViewById(R.id.saveButtonIdScannedLinkedin);
        savedSuccessBtn = (CircleImageView) findViewById(R.id.savedSuccessButtonIdScannedLinkedin);
        saveTxtView = (TextView) findViewById(R.id.saveTxtViewIdScannedLinkedin);
        savedSuccessTxtView = (TextView) findViewById(R.id.savedSuccessTxtViewIdScannedLinkedin);
        saveQrCodeToScannedFragmentButton();

        generateLinkedinQRCode(myUsername);
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            openLinkedinBtn.setColorFilter(ContextCompat.getColor(this, R.color.white));
            ...
            openLinkedinBtn.setColorFilter(ContextCompat.getColor(this, R.color.black));
    ...
    private void generateLinkedinQRCode(String username) {
        String linkedinAccount = "https://www.linkedin.com/in/" + username;
        ...
        try {
            ...
            BitMatrix bitMatrix = qrCodeWriter.encode(linkedinAccount, BarcodeFormat.QR_CODE, 500, 500, hints);
    ...
    private void saveQrCodeToScannedFragmentButton() {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String scanned_QrCode_Type = getResources().getString(R.string.Linkedin);
                dataBaseHelperScanned.addData_Scanned(new ScannedQrCode(scanned_QrCode_Type , getResources().getString(R.string.Username_hint)+": " + myUsername , qrCodeImageBytes , R.drawable.linkedin_icon));
    ...
    private void openLinkedinButton() {
        openLinkedinBtn = (CircleImageView) findViewById(R.id.openInstagramButtonIdScannedLinkedin);
        openLinkedinBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Check if the LinkedIn app is installed
                boolean appInstalled = isAppInstalled("com.linkedin.android");
                if (appInstalled) {
                    // LinkedIn app is installed, open it
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setPackage("com.linkedin.android");
                    intent.setData(Uri.parse("https://www.linkedin.com/in/" + myUsername));
                    startActivity(intent);
                } else {
                    // LinkedIn app is not installed, open the LinkedIn website
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setData(Uri.parse("https://www.linkedin.com/in/" + myUsername));
                    startActivity(intent);
                }
    ...
    private void copyButton() {
        copyBtn = (CircleImageView) findViewById(R.id.copyButtonIdScannedLinkedin);
        copiedSuccessBtn = (CircleImageView) findViewById(R.id.copiedSuccessButtonIdScannedLinkedin);
        copyTxtView = (TextView) findViewById(R.id.copyTxtViewIdScannedLinkedin);
        copiedSuccessTxtView = (TextView) findViewById(R.id.copiedSuccessTxtViewIdScannedLinkedin);
    ...
    private void searchOnWebButton() {
        searchOnWebBtn = (CircleImageView) findViewById(R.id.searchOnWebButtonIdScannedLinkedin);
        searchOnWebBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ScannedLinkedin.this , InAppBrowser.class);
    ...
    private void arrowBack() {
        CardView arrowBack = (CardView) findViewById(R.id.arrowback_from_ScannedLinkedinId);
        arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //For Back from Activity to Fragment !!!!!
                ScannedLinkedin.super.onBackPressed();
            }
        });
    }
